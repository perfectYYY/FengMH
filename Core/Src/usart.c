...
/* USER CODE BEGIN 0 */
#define RS485_SWAP_TX_RX_IN_SOFTWARE 0U

static void RS485_GPIO_SetVeryHighSpeed(GPIO_TypeDef *gpio, uint16_t pins)
{
  for (uint32_t bit = 0; bit < 16U; bit++)
  {
    ...
    if ((pins & mask) != 0U)
    {
      gpio->OSPEEDR = (gpio->OSPEEDR & ~(3UL << (bit * 2U))) | (3UL << (bit * 2U));
    }
  }
}

static void RS485_UART_ApplyBusPolarity(UART_HandleTypeDef *huart)
{
  __HAL_UART_DISABLE(huart);
  CLEAR_BIT(huart->Instance->CR2, USART_CR2_TXINV | USART_CR2_RXINV | USART_CR2_SWAP);
#if RS485_SWAP_TX_RX_IN_SOFTWARE
...
void MX_UART4_Init(void)
{
  ...
  RS485_UART_ApplyBusPolarity(&huart4);
...
void MX_UART7_Init(void)
{
  ...
  RS485_UART_ApplyBusPolarity(&huart7);
...
void MX_USART2_UART_Init(void)
{
  ...
  RS485_UART_ApplyBusPolarity(&huart2);
...
void MX_USART3_UART_Init(void)
{
  ...
  RS485_UART_ApplyBusPolarity(&huart3);
...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
  ...
  /* USER CODE BEGIN UART4_MspInit 1 */
    RS485_GPIO_SetVeryHighSpeed(GPIOA, GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_15);
  ...
  */
  ...
  /* USER CODE BEGIN UART7_MspInit 1 */
    RS485_GPIO_SetVeryHighSpeed(GPIOE, GPIO_PIN_7|GPIO_PIN_8|GPIO_PIN_9);
  ...
  */
  ...
  /* USER CODE BEGIN USART2_MspInit 1 */
    RS485_GPIO_SetVeryHighSpeed(GPIOD, GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_6);
  ...
  */
  ...
  /* USER CODE BEGIN USART3_MspInit 1 */
    RS485_GPIO_SetVeryHighSpeed(GPIOB, GPIO_PIN_14);
    RS485_GPIO_SetVeryHighSpeed(GPIOD, GPIO_PIN_8|GPIO_PIN_9);
